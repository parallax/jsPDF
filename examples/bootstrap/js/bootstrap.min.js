    ...
    Dropdown.prototype = {
      ...
      keydown: function(e) {
        ...
        if (
          ...
          (($this = $(this)), e.preventDefault(), e.stopPropagation(), !$this.is(".disabled, :disabled"))
        ) {
          if (
            (($parent = getParent($this)),
            (isActive = $parent.hasClass("open")),
    ...
    Tooltip.prototype = {
      ...
      getTitle: function() {
        var title,
          ...
          o = this.options;
        return (title =
          $e.attr("data-original-title") || ("function" == typeof o.title ? o.title.call($e[0]) : o.title));
      },
      tip: function() {
    ...
    Popover.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
      ...
      getContent: function() {
        var content,
          ...
          o = this.options;
        return (content =
          $e.attr("data-content") || ("function" == typeof o.content ? o.content.call($e[0]) : o.content));
      },
      tip: function() {
        ...
        (this.offsets = $([])),
          ...
          ($targets = this.$body
            ...
            .map(function() {
              ...
              return (
                ($href && $href.length && [[$href.position().top + self.$scrollElement.scrollTop(), href]]) || null
              );
            })
            .sort(function(a, b) {
              return a[0] - b[0];
        ...
        "object" != typeof offset && (offsetBottom = offsetTop = offset),
          ...
          (affix =
            null != this.unpin && scrollTop + this.unpin <= position.top
              ? !1
              : null != offsetBottom && position.top + this.$element.height() >= scrollHeight - offsetBottom
                ? "bottom"
