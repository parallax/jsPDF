      ...
      return {
        top:
          ...
          (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed"
            ? 0
            : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : g ? 0 : f.scrollTop()) * d),
        left:
          c.left +
          ...
          (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed"
            ? 0
            : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : g ? 0 : f.scrollLeft()) * d)
      };
    },
        ...
        for (var k = d.snapElements.length - 1; k >= 0; k--) {
          ...
          if (
            ...
            d.snapElements[k].snapping &&
              ...
              d.options.snap.release.call(d.element, b, a.extend(d._uiHash(), { snapItem: d.snapElements[k].item })),
          ...
          if (e.snapMode != "inner") {
            ...
            p &&
              (c.position.top =
                d._convertPositionTo("relative", { top: n - d.helperProportions.height, left: 0 }).top - d.margins.top),
              q && (c.position.top = d._convertPositionTo("relative", { top: o, left: 0 }).top - d.margins.top),
              r &&
                (c.position.left =
                  d._convertPositionTo("relative", { top: 0, left: l - d.helperProportions.width }).left -
                  d.margins.left),
          ...
          if (e.snapMode != "outer") {
            ...
            p && (c.position.top = d._convertPositionTo("relative", { top: n, left: 0 }).top - d.margins.top),
              q &&
                (c.position.top =
                  d._convertPositionTo("relative", { top: o - d.helperProportions.height, left: 0 }).top -
                  d.margins.top),
              r && (c.position.left = d._convertPositionTo("relative", { top: 0, left: l }).left - d.margins.left),
              s &&
                (c.position.left =
                  d._convertPositionTo("relative", { top: 0, left: m - d.helperProportions.width }).left -
                  d.margins.left);
          }
          !d.snapElements[k].snapping &&
            (p || q || r || s || t) &&
            d.options.snap.snap &&
            d.options.snap.snap.call(d.element, b, a.extend(d._uiHash(), { snapItem: d.snapElements[k].item })),
            ...
            a(b).each(function() {
              ...
              a.each(i, function(a, b) {
                ...
                a.browser.opera &&
                  ...
                  ((d._revertToRelativePosition = !0), b.css({ position: "absolute", top: "auto", left: "auto" })),
                b.css(g);
            });
          };
      ...
      resize: function(b, c) {
        ...
        l[0] != document && /static/.test(l.css("position")) && (k = g),
          i.left < (d._helper ? g.left : 0) &&
            ((d.size.width = d.size.width + (d._helper ? d.position.left - g.left : d.position.left - k.left)),
            j && (d.size.height = d.size.width / e.aspectRatio),
            (d.position.left = e.helper ? g.left : 0)),
          i.top < (d._helper ? g.top : 0) &&
            ((d.size.height = d.size.height + (d._helper ? d.position.top - g.top : d.position.top)),
        ...
        o && p && (m -= d.parentData.left),
          m + d.size.width >= d.parentData.width &&
            ((d.size.width = d.parentData.width - m), j && (d.size.height = d.size.width / d.aspectRatio)),
          ...
          this.selectees.each(function() {
            ...
            if (!!i && i.element != c.element[0]) {
              ...
              d.tolerance == "touch"
                ...
                : d.tolerance == "fit" && (j = i.left > e && i.right < g && i.top > f && i.bottom < h),
                j
 ...
 */ (function(
  ...
  a.widget("ui.sortable", a.ui.mouse, {
    ...
    _setOption: function(b, c) {
      b === "disabled"
        ? ((this.options[b] = c), this.widget()[c ? "addClass" : "removeClass"]("ui-sortable-disabled"))
        : a.Widget.prototype._setOption.apply(this, arguments);
    },
    ...
    _mouseStart: function(b, c, d) {
      ...
      (this.currentContainer = this),
        ...
        e.cursor &&
          (a("body").css("cursor") && (this._storedCursor = a("body").css("cursor")),
        ...
        this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML"
          ...
          : (b.pageY - a(document).scrollTop() < c.scrollSensitivity
            ...
            b.pageX - a(document).scrollLeft() < c.scrollSensitivity
              ...
              : a(window).width() - (b.pageX - a(document).scrollLeft()) < c.scrollSensitivity &&
                (d = a(document).scrollLeft(a(document).scrollLeft() + c.scrollSpeed))),
    ...
    _intersectsWith: function(a) {
      ...
      return this.options.tolerance == "pointer" ||
        ...
        (this.options.tolerance != "pointer" &&
          this.helperProportions[this.floating ? "width" : "height"] > a[this.floating ? "width" : "height"])
        ? l
    ...
    _generatePosition: function(b) {
      ...
      if (this.originalPosition) {
        ...
        if (c.grid) {
          ...
          g = this.containment
            ? h - this.offset.click.top < this.containment[1] || h - this.offset.click.top > this.containment[3]
  ...
  a.widget("ui.accordion", {
    ...
    _create: function() {
      ...
      (b.active = b
        ...
        b.headers
          ...
          .hide(),
        b.active.length
          ? b.active.attr({ "aria-expanded": "true", "aria-selected": "true", tabIndex: 0 })
      ...
      a.Widget.prototype._setOption.apply(this, arguments),
        ...
        b == "disabled" &&
          this.headers
            ...
            [c ? "addClass" : "removeClass"]("ui-accordion-disabled ui-state-disabled");
    },
    _keydown: function(b) {
    ...
    _toggle: function(b, c, d, e, f) {
      ...
      if (h.animated) {
        var j = {};
        h.collapsible && e
          ? (j = { toShow: a([]), toHide: c, complete: i, down: f, autoHeight: h.autoHeight || h.fillSpace })
          : (j = { toShow: b, toHide: c, complete: i, down: f, autoHeight: h.autoHeight || h.fillSpace }),
      ...
      if (this.type === "input") this.options.label && this.element.val(this.options.label);
        ...
        d.primary || d.secondary
          ? (this.options.text && f.push("ui-button-text-icon" + (e ? "s" : d.primary ? "-primary" : "-secondary")),
            ...
            this.options.text ||
              (f.push(e ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || b.attr("title", c)))
      ...
      (this.handles = e.add(a(h.join("")).appendTo(b.element))),
        ...
        this.handles
          ...
          .keyup(function(c) {
            ...
            b._keySliding &&
              ((b._keySliding = !1), b._stop(c, d), b._change(c, d), a(this).removeClass("ui-state-active"));
          }),
        this._refreshValue(),
        (this._animateOff = !1);
    },
            ...
            (f = ((d.values(b) - d._valueMin()) / (d._valueMax() - d._valueMin())) * 100),
              ...
              d.options.range === !0 &&
                (d.orientation === "horizontal"
                  ? (b === 0 && d.range.stop(1, 1)[e ? "animate" : "css"]({ left: f + "%" }, c.animate),
                    b === 1 &&
                      d.range[e ? "animate" : "css"]({ width: f - h + "%" }, { queue: !1, duration: c.animate }))
                  : (b === 0 && d.range.stop(1, 1)[e ? "animate" : "css"]({ bottom: f + "%" }, c.animate),
                    b === 1 &&
                      d.range[e ? "animate" : "css"]({ height: f - h + "%" }, { queue: !1, duration: c.animate }))),
              (h = f);
          })
        : ((i = this.value()),
          (j = this._valueMin()),
          ...
          b === "max" &&
            this.orientation === "horizontal" &&
            this.range[e ? "animate" : "css"]({ width: 100 - f + "%" }, { queue: !1, duration: c.animate }),
          b === "min" &&
 ...
 */ (function(
  ...
  a.widget("ui.tabs", {
    ...
    _tabId: function(a) {
      return (
        (a.title && a.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "")) || this.options.idPrefix + e()
      );
    },
    ...
    _tabify: function(c) {
      ...
      (this.list = this.element.find("ol,ul").eq(0)),
        ...
        this.anchors.each(function(b, c) {
          var g = a(c).attr("href"),
            ...
            i;
          h &&
            (h === location.toString().split("#")[0] || ((i = a("base")[0]) && h === i.href)) &&
            ((g = c.hash), (c.href = g));
      ...
      for (var g = 0, h; (h = this.lis[g]); g++)
        a(h)[a.inArray(g, e.disabled) != -1 && !a(h).hasClass("ui-tabs-selected") ? "addClass" : "removeClass"](
          "ui-state-disabled"
        );
  ...
  $.extend(Datepicker.prototype, {
    ...
    _dialogDatepicker: function(a, b, c, d, e) {
      ...
      if (!f) {
        ...
        var g = "dp" + this.uuid;
        (this._dialogInput = $(
          '<input type="text" id="' + g + '" style="position: absolute; top: -100px; width: 0px; z-index: -10;"/>'
        )),
    ...
    _hideDatepicker: function(a) {
      ...
      if (!(!b || (a && b != $.data(a, PROP_NAME))) && this._datepickerShowing) {
        ...
        $.effects && $.effects[c]
          ...
          : b.dpDiv[c == "slideDown" ? "slideUp" : c == "fadeIn" ? "fadeOut" : "hide"](c ? d : null, f),
          c || f(),
          (this._datepickerShowing = !1);
    ...
    _selectMonthYear: function(a, b, c) {
      var d = $(a),
        e = this._getInst(d[0]);
      (e["selected" + (c == "M" ? "Month" : "Year")] = e["draw" + (c == "M" ? "Month" : "Year")] = parseInt(
  ...
  a.widget("ui.progressbar", {
    ...
    _create: function() {
      this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({
        ...
        (this.valueDiv = a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(
          this.element
        )),
  ...
  a.effects.fold = function(b) {
    return this.queue(function() {
      ...
      m && (f = (parseInt(m[1], 10) / 100) * l[e == "hide" ? 0 : 1]),
        e == "show" && i.css(g ? { height: 0, width: f } : { height: f, width: 0 });
      var n = {},
        p = {};
      (n[k[0]] = e == "show" ? l[0] : f),
        (p[k[1]] = e == "show" ? l[1] : 0),
          ...
          (h = h.concat(["marginTop", "marginBottom"]).concat(g)),
            ...
            c.find("*[width]").each(function() {
              ...
              (child.from = { height: c.height * q.from.y, width: c.width * q.from.x }),
                ...
                q.from.y != q.to.y &&
                  ((child.from = a.effects.setTransition(child, h, q.from.y, child.from)),
                  (child.to = a.effects.setTransition(child, h, q.to.y, child.to))),
                q.from.x != q.to.x &&
                  ((child.from = a.effects.setTransition(child, i, q.from.x, child.from)),
