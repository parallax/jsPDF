...
{w:g[0],h:g[1],cs:"DeviceRGB",bpc:8,f:"DCTDecode",i:p,data:a};j[p]=a;!i&&!k&&(k=i=-96);0>i&&(i=-72*a.w/i/this.internal.scaleFactor);0>k&&(k=-72*a.h/k/this.internal.scaleFactor);0===i&&(i=k*a.w/a.h);0===k&&(k=i*a.h/a.w);this.internal.write("q",o(i),"0 0",o(k),o(b),r(l+k),"cm /I"+a.i,"Do Q");return this}})(jsPDF.API);;define(function(){return jsPDF})})();