;(function(){/*
 jsPDF ( 2012-06-20T18:48 commit ID d73477851505e8560e9e151d22f5feb2bb4bc132 )
...
{w:f[0],h:f[1],cs:"DeviceRGB",bpc:8,f:"DCTDecode",i:p,data:a};k[p]=a;!i&&!j&&(j=i=-96);0>i&&(i=-72*a.w/i/this.internal.scaleFactor);0>j&&(j=-72*a.h/j/this.internal.scaleFactor);0===i&&(i=j*a.w/a.h);0===j&&(j=i*a.h/a.w);this.internal.write("q",o(i),"0 0",o(j),o(c),r(l+j),"cm /I"+a.i,"Do Q");return this}})(jsPDF.API);;define(function(){return jsPDF})})();