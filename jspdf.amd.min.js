...
{w:h[0],h:h[1],cs:"DeviceRGB",bpc:8,f:"DCTDecode",i:f,data:i};c[f]=i;!e&&!l&&(l=e=-96);0>e&&(e=-72*i.w/e/this.internal.scaleFactor);0>l&&(l=-72*i.h/l/this.internal.scaleFactor);0===e&&(e=l*i.w/i.h);0===l&&(l=e*i.h/i.w);this.internal.write("q",o(e),"0 0",o(l),o(b),w(a+l),"cm /I"+i.i,"Do Q");return this}})(jsPDF.API);;define(function(){return jsPDF})})();