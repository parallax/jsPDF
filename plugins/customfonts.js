(function(jsPDFAPI) {
  ...
  var TTFFont = (function() {
    ...
    TTFFont.prototype.characterToGlyph = function(character) {
      var _ref;
      return (
        ((_ref = this.cmap.unicode) !== undefined
    ...
    TTFFont.prototype.encode = function(font, text, reverse) {
      ...
      text = reverse
        ? reverseString(font.encodeText(text))
    ...
    TTFFont.prototype.embedTTF = function(encoding, newObject, out) {
      ...
      function makeFontTable(data) {
        ...
        if (data.Type === "Font") {
          ...
          out("stream");
          Array.isArray(data) || data.constructor === Uint8Array
            ? out(toString(data))
            : out(data);
          out("endstream");
        }
    ...
    var makeWidths = function(font) {
      ...
      Object.keys(codeMap).map(function(key) {
        ...
        var AssignedValue = Math.round(
          font.hmtx.metrics[codeMap[key]].advance * scale
        );
  ...
  var NameTable = (function(_super) {
    ...
    NameTable.prototype.encode = function() {
      ...
      postscriptName = new NameEntry(
        "" + subsetTag + "+" + this.postscriptName,
        {
          platformID: 1,
          encodingID: 0,
          languageID: 0
  ...
  jsPDFAPI.events.push([
    ...
    function(font) {
      if (jsPDFAPI.existsFileInVFS(font.postScriptName)) {
        font.metadata = TTFFont.open(
          font.postScriptName,
          font.fontName,
          jsPDFAPI.getFileFromVFS(font.postScriptName),
          font.encoding
        );
        font.encoding =
          font.metadata.hmtx.widths.length < 500 &&
          font.metadata.capHeight < 800
            ? "WinAnsiEncoding"
            : "MacRomanEncoding";
      }
    }
