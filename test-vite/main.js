...
document.addEventListener('DOMContentLoaded', () => {
  ...
  button.addEventListener('click', () => {
    try {
      ...
      status.innerHTML = '<span style="color: green;">✅ Success! PDF generated successfully.</span>';
  ...
  try {
    ...
    status.innerHTML = '<span style="color: blue;">📦 jsPDF imported successfully! Click the button to test PDF generation.</span>';
  } catch (error) {
