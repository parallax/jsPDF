...
describe("Module: RGBASupport", () => {
  ...
  if (
    ...
    const compressionCases = ["NONE", "FAST", "MEDIUM", "SLOW"]
    for (const compression of compressionCases) {
      it(`rgba_compression_${compression}`, () => {
        const doc = new jsPDF({
          orientation: "p",
          unit: "px",
          format: "a4",
        ...
        comparePdf(doc.output(), `rgba_compression_${compression}.pdf`, "addimage");
      });
    }
  }
});
